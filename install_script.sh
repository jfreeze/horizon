...
install_elixir() {
    ...
    cd "$WORKDIR" || { output_message "error" "Failed to enter directory $WORKDIR."; return 1; }
    ...
    cd elixir || { output_message "error" "Failed to enter elixir directory."; return 1; }
    ...
    # Compile Elixir
    if ! run_cmd gmake clean test; then
